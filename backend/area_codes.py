# Pre-compiled list of active and valid North American Numbering Plan (NANP) area codes
# Sources: nationalnanpa.com and verified open-source indexes
# Excludes N11, N9X, and codes starting with 0 or 1.
